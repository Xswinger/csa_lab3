...
```ebnf
<program> ::= <code_line>
<code_line> ::= <data_definition> |<label_definition> | <command> | <data>
...
|----|----|----|
|  add  |  Сумма содержимого 2 регистров и сохранение результата в 3 регистре  | tr1 + tr2 -> tr3 |
...
|  cmp  |  Сравнить содержимое регистров и выставить флаги состояния  |  tr1 - tr2  |
|  test  |  Логическое И между всеми битами содержимого 2 регистров  |  tr1 & tr2  |
...
|  load  |  Загрузить содержимое по адресу из памяти в регистр  |  addr -> tr1  |
